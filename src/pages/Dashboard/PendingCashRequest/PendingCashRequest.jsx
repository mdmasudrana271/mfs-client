...
const PendingCashRequest = () => {
  ...
  console.log("all pendings: ", requests);
  ...
  return (
    <>
      <div className="mx-5 my-10">
        <section>
          <h2 className="text-3xl font-bold">Agents Money Request</h2>
          {requests?.length > 0 ? (
            <div className="my-5">
            ...
            <p className="text-2xl text-center  text-error">
              Not Found Pending Money request
            </p>
          )}
        </section>
      </div>
...
export default PendingCashRequest;
