...
const SendMoney = () => {
  ...
  const handleCashIn = async (data) => {
    ...
    const payload = {
      senderId: user._id,
      recipientNo: data.recipientMobile,
    ...
    <div className="max-w-lg mx-auto my-10 p-5 bg-white border border-gray-200 rounded shadow">
      ...
      {success && (
        <div className="text-green-600 text-center mb-4">
          <p>
            Send Money transaction successful! Your balance has been updated.
          </p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(handleCashIn)}>
        ...
        >
          {isProcessing ? "Processing..." : "Complete Send Money"}
        </button>
      </form>
    </div>
  );
